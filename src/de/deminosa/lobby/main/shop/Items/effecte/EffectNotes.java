...
public class EffectNotes implements ShopItemBuilder{
	...
	public void getAction(Player player) {
		CorePlayerData.setData(CoreCache.getCorePlayer(player), "lobby", "effect", EnumParticle.NOTE.name());
	}

	@Override
	public ItemStack getIcon(CorePlayer player) {
		return new ItemBuilder(Material.NOTE_BLOCK).setName("§6"+getItemName())
				.addLoreLine("")
