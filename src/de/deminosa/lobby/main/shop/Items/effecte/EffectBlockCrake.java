...
public class EffectBlockCrake implements ShopItemBuilder{
	...
	public String getItemName() {
		return "Block Zerstören";
	}

	@Override
	public void getAction(Player player) {
		CorePlayerData.setData(CoreCache.getCorePlayer(player), "lobby", "effect", EnumParticle.BLOCK_CRACK.name());
	}

	@Override
	public ItemStack getIcon(CorePlayer player) {
		return new ItemBuilder(Material.STONE_PICKAXE).setName("§6"+getItemName())
				.addLoreLine("")
