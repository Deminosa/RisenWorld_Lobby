...
public class EffectMagicSpell implements ShopItemBuilder{
	...
	public String getItemName() {
		return "Magischer Zauber";
	}

	@Override
	public void getAction(Player player) {
		CorePlayerData.setData(CoreCache.getCorePlayer(player), "lobby", "effect", EnumParticle.SPELL_WITCH.name());
	}

	@Override
	public ItemStack getIcon(CorePlayer player) {
		return new ItemBuilder(Material.EXP_BOTTLE).setName("§6"+getItemName())
				.addLoreLine("")
