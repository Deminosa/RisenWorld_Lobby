...
public class EffectExplode implements ShopItemBuilder{
	...
	public void getAction(Player player) {
		CorePlayerData.setData(CoreCache.getCorePlayer(player), "lobby", "effect", EnumParticle.EXPLOSION_NORMAL.name());
	}

	@Override
	public ItemStack getIcon(CorePlayer player) {
		return new ItemBuilder(Material.TNT).setName("§6"+getItemName())
				.addLoreLine("")
