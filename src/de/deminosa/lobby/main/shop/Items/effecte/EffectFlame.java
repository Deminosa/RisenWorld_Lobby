...
public class EffectFlame implements ShopItemBuilder{
	...
	public void getAction(Player player) {
		CorePlayerData.setData(CoreCache.getCorePlayer(player), "lobby", "effect", EnumParticle.FLAME.name());
	}

	@Override
	public ItemStack getIcon(CorePlayer player) {
		return new ItemBuilder(Material.BLAZE_ROD).setName("§6"+getItemName())
				.addLoreLine("")
